            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  _buildOutlineField(context, Icons.mail_outline, "Email", "amelia@example.com"),
                  const SizedBox(height: 15),
                  _buildOutlineField(context, Icons.phone_outlined, "Phone Number", "+62 812 3456 789"),
                  const SizedBox(height: 15),
                  _buildOutlineField(context, Icons.location_on_outlined, "Location", "Jakarta, Indonesia"),
                ],
              ),
            ),
          ),
